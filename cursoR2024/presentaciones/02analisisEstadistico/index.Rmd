---
title: "Análisis de datos con DPLYR y funciones de resumen"
...
library(dplyr)
# Se carga la librería de gráficas plotly:
library(plotly)
```
...
- openxlsx: Para importar los datos de un archivo de Excel.
- DT: Para presentar los datos en una tabla interactiva.
- dplyr: Para realizar análisis de datos.
- plotly: Para realizar gráficas interactivas.

```{r importaDatosArroz, message=FALSE, warning=FALSE,error=FALSE}
# Con la librería cargada, se importan los datos de los precios del arroz:
Datos=read.xlsx("https://github.com/OscarVDelatorreTorres/cursoRstudio2024FCCA/raw/main/datosArroz.xlsx")
